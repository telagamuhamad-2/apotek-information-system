...
@section('header-title', 'Edit Jenis Obat')
...
<div class="bg-white rounded-xl shadow-sm">
    <div class="p-6 border-b border-gray-200">
        ...
        <h2 class="text-xl font-semibold text-gray-800">
            <i class="fas fa-edit mr-2 text-emerald-600"></i>Edit Jenis Obat
        </h2>
    </div>

    <form method="POST" action="{{ route('product-types.update', $productType->id) }}" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('product_type_name', $productType->product_type_name) }}"
                       required
                       autofocus
            ...
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('product_type_prefix', $productType->product_type_prefix) }}"
                       maxlength="10"
